...
$(function(){
	$("body").on("click","[data-proto-drawer]",protoSliderActivator);
	$("body").on("click","[data-proto-drawer-click]",protoSliderActivator);
	$("body").on("mouseenter","[data-proto-drawer-mouseenter]",protoSliderActivator);
	$("body").on("mouseleave","[data-proto-drawer-mouseleave]",protoSliderActivator);
	$("body").on("mouseenter mouseleave","[data-proto-drawer-hover]",protoSliderActivator);
})